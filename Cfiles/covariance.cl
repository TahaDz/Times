...
__kernel void reduce_kernel(__global float *mean, __global float *data, int m, int n)
{
	int j = get_global_id(0);    
...
__kernel void covar_kernel(__global float *symmat, __global float *data, int m, int n)
{
